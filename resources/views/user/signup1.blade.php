    ...
    <div class="container ">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mb-1">
                <h2 class="heading-section">Wishlist Website Sign up</h2>
            </div>
        </div>
        <div class="row justify-content-center">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('signup.store') }}">
                    ...
                    <button type="submit" class="form-control btn btn-primary submit mt-2 px-3">Sign Up</button>
                </form>
                <p class="mt-3 text-center">Already have an account? <a href="{{ route('login') }}" class="">Login here</a></p>
            </div>
